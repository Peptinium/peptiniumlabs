    ...
    <section data-reveal-blur className="relative overflow-hidden bg-background">
      ...
      <div className="container-prose relative flex flex-col items-center px-5 pt-20 pb-24 text-center lg:pt-28 lg:pb-32">
        ...
        <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
          <Link
            to="/produits"
            className="group inline-flex items-center gap-3 rounded-full px-8 py-4 font-sans text-[12px] font-semibold uppercase tracking-[0.22em] text-white shadow-[0_18px_44px_-18px_color-mix(in_oklab,var(--brand-violet)_70%,transparent)] transition-all duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] hover:-translate-y-0.5 hover:shadow-[0_24px_54px_-18px_color-mix(in_oklab,var(--brand-violet)_85%,transparent)]"
            style={{
              backgroundImage:
