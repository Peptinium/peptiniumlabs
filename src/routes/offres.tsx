...
const TIERS = [
  {
    ...
    name: "Bronze",
    range: "0 – 1 000 €",
    perks: ["1 % crédit sur chaque commande", "CoA HPLC systématique", "Accès prioritaire au support"],
  ...
  },
  {
    ...
    name: "Or",
    range: "3 000 – 6 000 €",
    perks: ["3 % crédit permanent", "Eau bactériostatique offerte sur commandes Retatrutide", "Support prioritaire dédié"],
  ...
  },
  {
    ...
    name: "Platine",
    range: "6 000 € et +",
    perks: ["5 % crédit permanent", "Accès en avant-première aux nouveaux lots", "Interlocuteur unique labo"],
